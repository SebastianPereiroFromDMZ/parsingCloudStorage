...
public class AuthService {
    ...
    public String loginUser(AuthRequest authRequest) {
        try {
            ...
            //authenticationManager.authenticate Пытается аутентифицировать переданный объект аутентификации, возвращая в случае успеха полностью
            //заполненный объект аутентификации (включая предоставленные полномочия).
